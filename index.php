...
<main class="ps-main">
            ...
            <ul>
                <li class="ps-banner" data-index="rs-2972" data-transition="random" data-slotamount="default"
                    data-hideafterloop="0" data-hideslideonmobile="off" data-rotate="0"><img class="rev-slidebg"
                        src="template/images/slider/3.jpg" alt="" data-bgposition="center center" data-bgfit="cover"
                ...
                <li class="ps-banner ps-banner--white" data-index="rs-100" data-transition="random"
                    data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-rotate="0"><img
                        class="rev-slidebg" src="template/images/slider/2.jpg" alt="" data-bgposition="center center"
    ...
    <div class="ps-section--offer">
        <div class="ps-column"><a class="ps-offer" href="product-listing.php"><img
                    src="template/images/banner/home-banner-1.png" alt=""></a></div>
        <div class="ps-column"><a class="ps-offer" href="product-listing.php"><img
                    src="template/images/banner/home-banner-2.png" alt=""></a></div>
    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 ">
                        <div class="ps-hotspot"><a class="point first active" href="javascript:;"><i
                            ...
                            </a><img src="template/images/hot-deal.png" alt=""></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="ps-home-testimonial bg--parallax pb-80" data-background="template/images/background/parallax.jpg">
        <div class="container">
            <div class="owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="0"
                ...
                <div class="ps-testimonial">
                    <div class="ps-testimonial__thumbnail"><img src="template/images/testimonial/1.jpg" alt=""><i
                ...
                <div class="ps-testimonial">
                    <div class="ps-testimonial__thumbnail"><img src="template/images/testimonial/2.jpg" alt=""><i
                            class="fa fa-quote-left"></i></div>
                    <header>
                        <select class="ps-rating">
                            <option value="1">1</option>
                ...
                <div class="ps-testimonial">
                    <div class="ps-testimonial__thumbnail"><img src="template/images/testimonial/3.jpg" alt=""><i
                            class="fa fa-quote-left"></i></div>
                    <header>
                        <select class="ps-rating">
                            <option value="1">1</option>
            ...
            <div class="ps-section__content">
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                        <div class="ps-post">
                            ...
                            <div class="ps-post__content"><a class="ps-post__title" href="blog-detail.php">An Inside
                                ...
                                </p><a class="ps-morelink" href="blog-detail.php">Read more<i
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                        <div class="ps-post">
                            <div class="ps-post__thumbnail"><a class="ps-post__overlay" href="blog-detail.php"></a><img
                                    src="template/images/blog/2.jpg" alt=""></div>
                            <div class="ps-post__content"><a class="ps-post__title" href="blog-detail.php">Unpacking
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                        <div class="ps-post">
                            <div class="ps-post__thumbnail"><a class="ps-post__overlay" href="blog-detail.php"></a><img
                                    src="template/images/blog/3.jpg" alt=""></div>
                            <div class="ps-post__content"><a class="ps-post__title" href="blog-detail.php">Nike’s
